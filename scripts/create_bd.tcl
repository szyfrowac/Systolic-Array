...
create_project -force bd_proj ./bd_proj -part $part
...
# Generate Wrapper
make_wrapper -files [get_files ./bd_proj/bd_proj.srcs/sources_1/bd/system/system.bd] -top
add_files -norecurse ./bd_proj/bd_proj.srcs/sources_1/bd/system/hdl/system_wrapper.v
