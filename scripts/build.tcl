...
# Read Source Files
read_verilog -sv [glob -nocomplain ./srcs/*.sv]
read_verilog [glob -nocomplain ./srcs/*.v]
read_verilog [glob -nocomplain ./srcs/fullAdder/*.v]
read_verilog [glob -nocomplain ./srcs/samesignedAdder/*.v]
