...
create_project -force vip_sim_proj ./vip_sim_proj -part $part
...
make_wrapper -files [get_files ./vip_sim_proj/vip_sim_proj.srcs/sources_1/bd/vip_bd/vip_bd.bd] -top
add_files -norecurse ./vip_sim_proj/vip_sim_proj.gen/sources_1/bd/vip_bd/hdl/vip_bd_wrapper.v
